...
import port03 from '../assets/img/port01.png'
import port04 from '../assets/img/port01.png'
import port05 from '../assets/img/port01.png'
import port06 from '../assets/img/port01.png'
import port07 from '../assets/img/port01.png'
import port08 from '../assets/img/port01.png'
import port09 from '../assets/img/port01.png'
import port10 from '../assets/img/port01.png'
...
export const skillText = [
    {
        title: "직업의 변화, 새로운 시작.",
        desc: "저의 가장 큰 도전은 직업 전환 이었습니다. 이전의 경험을 새로운 분야로 적용하고 학습 곡선을 극복하며, 제 창의력과 역량을 증명하는 과정이었습니다."
    },
    {
        title: "프로젝트 리더십 도전",
        desc: "프로젝트 리더로서 일한 경험에서 가장 큰 도전은 팀을 효과적으로 조직하고 목표를 달성하는 것이었습니다. 다양한 관심사와 역량을 가진 팀원들을 통합하고 프로젝트를 성공적으로 완료하는 데 중요한 역할을 했습니다."
    },
    {
        title: "시간 관리와 스트레스 관리 도전",
        desc: "일과 학업을 병행하면서 시간 관리와 스트레스 관리의 도전을 경험했습니다. 이러한 상황에서 효과적으로 일정을 조절하고 스트레스를 관리하며, 업무와 학업 양립을 성취한 경험을 통해 도전을 극복했습니다."
    }
]
...
export const siteText = [
    {
        ...
        code: "https://github.com/uUZINN/react-project2023",
        view: "https://vite-project2023-uzin.netlify.app",
        info: [
            "site coding",
            "production period : two days",
            "site coding : html5/css, css variable, vite"
        ]
    },
    {
        text: ["make", "site compliant width", "webstandard"],
...
export const contactText = [
    {
        ...
        title: "KAKAO : dbwls90388141",
    },
    {
        link: "mailto:dbwls9038@naver.com",
        title: "MAIL : dbwls9038@naver.com",
    },
];
